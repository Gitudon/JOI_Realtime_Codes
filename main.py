                ...
                if type(session)!=str:
                    ...
                    if submission_urls=={}:
                        ...
                        if problem_name in submission_urls:
                            ...
                            result_html=f'<center><span style="font-size:20px;">{student}: </span> <span style="color:{color_dict[result]};font-size:20px;"><b>{result}</b></span><span style="font-size:20px;"> ({answer_time})</span></center>'
